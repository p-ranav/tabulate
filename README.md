...
The following table prints the phrase `I love you` in different languages. You can explicitly set the locale for a cell using `.format().locale(value)`. Note that the locale string is system-specific.
