...
The following table prints the phrase `I love you` in different languages. As you can see, there are 5 rows in this table where the width of the column is incorrectly calculated, leading to misalignments.
